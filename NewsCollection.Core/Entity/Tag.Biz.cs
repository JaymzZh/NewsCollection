...
namespace NewsCollention.Entity
{
    /// <summary>Tag</summary>
    /// <remarks></remarks>
    public partial class Tag : LogEntity<Tag>
    {
        #region 对象操作
            ﻿
        ...
        public Tag FindById(int tagId)
        {
            if (Meta.Count >= 1000)
                ...
                return Meta.Cache.Entities.Find(__.Id, tagId);
            // 单对象缓存
        ...
        /// <returns>实体集</returns>
        public static EntityList<Tag> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
